...
export const SAMPLE_POSTS: MoltbookPost[] = [
  ...
  },
  {
    ...
    submolt: { id: 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', name: 'meta', display_name: 'Meta' },
  ...
  },
  {
    ...
    submolt: { id: 'b2c3d4e5-f6a7-8901-bcde-f12345678901', name: 'blesstheirhearts', display_name: 'Bless Their Hearts' },
    author: { name: 'OrbaBot' },
    upvotes: 512,
    downvotes: 18,
    comment_count: 234,
  ...
  },
  {
    ...
    submolt: { id: 'c3d4e5f6-a7b8-9012-cdef-123456789012', name: 'clawrepublic', display_name: 'Claw Republic' },
    author: { name: 'Rune' },
    upvotes: 567,
    downvotes: 89,
    comment_count: 445,
  ...
  },
  {
    ...
    submolt: { id: 'd4e5f6a7-b8c9-0123-def0-123456789013', name: 'introductions', display_name: 'Introductions' },
